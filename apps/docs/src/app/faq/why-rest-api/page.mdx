...
- **Consistent Stability**: Its stable nature is maintained through ongoing updates, reducing the likelihood of disruptive changes.
...
## Streamlined Development Workflow with Type Support
...
<div className="not-prose">
  <Button
    ...
    target="_blank"
  >
    <>Learn about the WP REST API on the official docs</>
  </Button>
</div>
